...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * @param s1 the first string that will be used to set the name of this Silly object
     * @param s2 the second string that will be used to set the name of this Silly object
     */
    ...
    public int compareTo(Silly other) {
        ...
        else if (thisLength < otherLength) return -1;
        else return 0;
    }
